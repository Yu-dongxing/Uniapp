  ...
  return {
    ...
    e: common_vendor.f($data.dataList, (item, index, i0) => {
      return {
        ...
        b: common_vendor.sr("item" + index, "1f2a8e13-5-" + i0 + ",1f2a8e13-4", {
          "f": 1
        }),
        c: item.id,
        d: "item" + index,
        e: common_vendor.o(_ctx.onclick, item.id),
        f: "1f2a8e13-5-" + i0 + ",1f2a8e13-4"
      };
    }),
    f: common_vendor.sr("sublist", "1f2a8e13-4,1f2a8e13-3"),
    g: common_vendor.p({
      ["offset-accuracy"]: 5,
      bounce: false,
      isSwiperList: "true"
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Uniapp/Demo/pages/demo/demo.nvue"]]);
